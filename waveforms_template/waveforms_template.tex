...
\tableheader{}{\textbf{\textit{Use this as a template, Usage hint in comments. Special characters will lead to a double quote, try with and w/o the comma}}}
\begin{scope}[semitransparent,ultra thin]
\vertlines[gray]{0,4,8,12,16,22,26,30,38,42,46,50,56,60,64,68,72,76,80,84,88}
\end{scope}
...
\draw [red,ultra thin, *-*] ($(H11>.MID)-(0.5,-0.25)$) -- ($(H15>.MID)-(0.5,0.25)$);
\draw [red,ultra thin, o->] ($(H13>.high)-(0.25,0)$)node[left=2pt]{} .. controls ++(6,0) and ++(-6,0) .. (N19>.high) node[above right=2pt] {};
\draw [red,ultra thin, o->] ($(N19>.low)-(0.25,0)$)node[left=2pt]{} .. controls ++(6,0) and ++(-6,0) .. (R27>.low) node[above right=2pt] {};
...
\draw [red,ultra thin, *->] ($(J19>.high)-(0.25,0)$)node[left=2pt]{} .. controls ++(6,0) and ++(-6,0) .. (J23>.MID) node[above right=2pt] {};
\draw [red,ultra thin, o->] ($(M27>.high)-(0.25,0)$)node[left=2pt]{} .. controls ++(6,0) and ++(-6,0) .. (M25>.MID) node[above right=2pt] {};
\draw [red,ultra thin, o->] ($(M27>.high)-(0.25,0)$)node[left=2pt]{} .. controls ++(6,0) and ++(-6,0) .. (M23>.MID) node[above right=2pt] {};
\draw [red,ultra thin, o->] ($(M27>.high)-(0.25,0)$)node[left=2pt]{} .. controls ++(6,0) and ++(-6,0) .. (M19>.low) node[above right=2pt] {};
\draw [red,ultra thin, *->] ($(J19>.MID)-(0.5,-0.25)$) -- ($(J23>.MID)-(0.5,-0.55)$);
\draw [red,ultra thin, *->] ($(J19>.MID)-(0.5,-0.25)$) -- ($(J25>.MID)-(0.5,-0.55)$);
\draw [red,ultra thin, *->] ($(J19>.MID)-(0.5,-0.25)$) -- ($(J27>.MID)-(0.5,-0.55)$);
...
\draw [gray, ultra thin, {Circle[length=1pt]}-] ($(H15>.HIGH)-(0.5,0.07)$) node[above=3,left=-1pt] {\tiny \em 1} -- ($(H15>.HIGH) +(-0.5,0.6)$);
\draw [gray, ultra thin, {Circle[length=1pt]}-] ($(E15>.HIGH)-(0.5,0.07)$) node[above=3,left=-1pt] {\tiny \em 2} -- ($(E15>.HIGH) +(-0.5,0.6)$);
\draw [gray, ultra thin, {Circle[length=1pt]}-] ($(I47>.HIGH)-(0.5,0.07)$) node[above=3,left=-1pt] {\tiny \em 3} -- ($(I47>.HIGH) +(-0.5,0.6)$);
\end{pgfonlayer}
\end{tikztimingtable}
